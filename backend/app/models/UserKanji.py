...
class UserKanjiEntry(Base):
    ...
    next_review_at : Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable = True) #when the kanji is first loaded, they will not have studied so it can not be up for review
